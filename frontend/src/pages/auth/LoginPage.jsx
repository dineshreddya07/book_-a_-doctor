...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaStethoscope, FaRobot, FaLockOpen } from 'react-icons/fa';
        ...
        <div className="row g-0">
          ...
          <div className="col-md-5 d-none d-md-flex flex-column justify-content-between p-5 text-white position-relative" 
            ...
            <div>
              ...
              <h2 className="fw-bold lh-sm mb-3">Healthcare Management Made Simple</h2>
              <p className="opacity-95 text-light small mb-4">
                Join our medical community to instantly connect with verified specialists, manage report archives, and consult clinical AI triages.
              </p>
            </div>
          ...
          <div className="col-md-7 p-4 p-md-5 bg-white d-flex flex-column justify-content-center">
            <div className="mb-4">
              ...
              <p className="text-secondary small">Please enter your registered credentials to access MedCare portals</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="d-flex flex-column gap-3.5">
              ...
              <button
                type="submit"
                className="btn btn-primary rounded-pill py-2.5 fw-bold shadow-sm mt-3 d-flex align-items-center justify-content-center gap-2 hover-scale"
                disabled={loading}
              >
                {loading ? (
                  <>
              ...
              <div className="text-center mt-4 pt-2 border-top border-light">
                <span className="text-secondary small">New to MedCare? </span>
